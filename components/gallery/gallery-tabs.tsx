  ...
  return (
    <div className="flex justify-center my-6" role="tablist" aria-label="Media Type Selector">
      <div className="relative flex p-1.5 bg-zinc-100 dark:bg-zinc-900 rounded-2xl border border-zinc-200/60 dark:border-zinc-800/80 shadow-inner">
        ...
        <div
          className={`absolute top-1.5 bottom-1.5 w-[calc(50%-6px)] bg-white dark:bg-zinc-800 rounded-xl shadow-sm transition-transform duration-300 ease-out-quad ${
            activeTab === "videos"
        ...
        <button
          ...
          type="button"
          className={`relative z-10 px-8 py-2 text-sm font-semibold rounded-xl transition-colors duration-200 cursor-pointer focus-visible:ring-2 focus-visible:ring-zinc-950 dark:focus-visible:ring-zinc-50 focus:outline-none ${
            activeTab === "photos"
